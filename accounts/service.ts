...
async function sendAlreadyRegisteredEmail(email: any, origin: any) {
    ...
    if (origin) {
        ...
        message = `<p>If you don't know your password please visit the <code>/account/forgot-password</code> API route.</p>`;
    }
    ...
    await sendEmail({
        ...
        html: `<h4>Email Already Registered</h4>
                <p>Your email address ${email} is already registered.</p>
                ${message}`
    });
}
